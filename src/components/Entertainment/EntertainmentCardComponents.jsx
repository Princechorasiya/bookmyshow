...
const EntertainmentCardComponents = (props) => {
	return (
		<>
			<div className="">
				<img
...
const EntertainmentCardComponentsSlider = () => {
		...
		<>
			<Slider {...settings}>
				{EntertainmentImage.map((image, index) => (
					<EntertainmentCardComponents src={image} key={index} />
				))}
			</Slider>
		</>
	);
...
export default EntertainmentCardComponentsSlider;
